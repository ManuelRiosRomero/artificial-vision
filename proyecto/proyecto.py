...
#--------------------------------------#
soa=sobel(srcA)
cv.imwrite("bordes/bordeA.png",soa)
...
#------------------------------------#
sob=sobel(srcB)
cv.imwrite("bordes/bordeB.png",sob)
...
#----------------------------------#
soc=sobel(srcC)
cv.imwrite("bordes/bordeC.png",soc)
...
#-----------------------------------#
sod=sobel(srcD)
cv.imwrite("bordes/bordeD.png",sod)
...
#-----------------------------------#
soe=sobel(srcE)
cv.imwrite("bordes/bordeE.png",soe)
